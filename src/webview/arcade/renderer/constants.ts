// @ts-nocheck -- vendored from MakeCode (pxt), kept verbatim so it can be
// re-fetched from upstream; written against pxt's looser compiler settings.
...
export class ConstantProvider extends Blockly.zelos.ConstantProvider {
    ...
    */
    ...
    override createDom(svg: SVGElement, selector: string, injectionDivIfIsParent?: HTMLElement,): void {
